...
```{r}
indicador <- 'Meta1'
tabela <- dplyr::tibble(Nome = dplyr::pull(dados[3, ], indicador), Valor = dplyr::pull(dados[1, ], indicador), Descrição = dplyr::pull(dados[4, ], indicador), Limite = dplyr::pull(dados[2, ], indicador))
criar.tabela(tabela)
```
:::
:::
